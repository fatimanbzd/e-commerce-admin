...
@Component({
  selector: 'admin-order-statistic-order-count',
  imports: [
  ...
  templateUrl: './order-statistic-order-count.component.html',
  styleUrl: './order-statistic-order-count.component.scss',
})
export class OrderStatisticOrderCountComponent {
  ...
  orderCountPerDate(filterModel: Partial<IOrderStatisticFilterModel> | null) {
    this.orderService
      .aggregateStatisticsOrderCount(filterModel)
      .pipe(
        mergeMap((values) => {
