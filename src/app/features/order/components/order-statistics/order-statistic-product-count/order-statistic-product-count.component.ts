...
@Component({
  selector: 'admin-order-statistic-product-count',
  imports: [
    DecimalPipe,
  ...
  templateUrl: './order-statistic-product-count.component.html',
  styleUrl: './order-statistic-product-count.component.scss',
})
export class OrderStatisticProductCountComponent {
  ...
  productCountPerDate(filterModel: Partial<IOrderStatisticFilterModel> | null) {
    this.orderService
      .aggregateStatisticsProductCount(filterModel)
      .pipe(
        mergeMap((values) => {
  ...
  renderChart(data: any) {
    this.chartOptions = {
      ...
      series: [
        {
          name: 'تعداد محصولات سفارش پرداخت شده',
        ...
        {
          name: 'تعداد محصولات سفارش پرداخت نشده',
